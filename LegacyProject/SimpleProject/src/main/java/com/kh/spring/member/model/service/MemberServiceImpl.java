...
public class MemberServiceImpl implements MemberService {
	...
	/*
	@Autowired
	pulbic MemberServiceImpl(SqlSessionTemplate sqlSession,
	...
	*/
	...
	public MemberDto login(MemberDto member) {
		...
		//log.info("DB에 저장된 암호환된 암호문 : {}",loginMember.getUserPwd());
	...
	public void update(MemberDto member, HttpSession session) {
		...
		// EMAIL컬럼 값이 EMAIL컬럼 크기보다 크지 않은가?
	...
	public void delete(String userPwd, HttpSession session) {
		...
		int result = memberMapper.delete(sessionMember.getUserId());

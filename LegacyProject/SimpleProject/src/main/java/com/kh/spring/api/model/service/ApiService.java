...
public class ApiService {
	...
	public String requestBeef() {
		...
		final String API_KEY = "e56247f714fa36a626352e39681434c488c7b4f2814b1c9c39b1c8c84c86b6df";
	...
	public String getBlog(String query) {

		String clientId = "bJFIN7BFvPcCTJcHzSmx"; // 애플리케이션 클라이언트 아이디
		String clientSecret = "8P0q_Qdwin"; // 애플리케이션 클라이언트 시크릿
		...
		String apiURL = "https://openapi.naver.com/v1/search/shop?query=" + text + "&start=1&sort=date"; // JSON 결과
		//String apiURL = "https://openapi.naver.com/v1/search/blog?query=" + text + "&start=1&sort=date"; // JSON 결과
	...
	public String requestBusan(int pageNo) {
		...
		final String SERVICE_KEY = "?serviceKey=76c539a75adc456135f055cc83bc3467c8c4318d828a7315931d092829416fb4";
		StringBuilder sb = new StringBuilder();

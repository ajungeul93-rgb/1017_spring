...
//	}
	...
	*/
	...
	public String login(/*@RequestParam(value="userId")String userId,@RequestParam(value="userPwd") String userPwd) {
		...
		System.out.println("으흐읗 id : " + userId + ",pwd : " + userPwd);
	...
	*/
	...
	public String login(/*@ModelAttribute MemberDto member,
		...
		log.info("Member개게 필드값 확인 ~{}", member);
		...
		if(loginMember != null) { // 로그인에 성공
			...
			// error_page -> 포워딩
			// requestScope에 msg하는 키값으로 로그인 실패입니다 ~~ 담아서 포워딩
	...
	*/
	...
	public String edit(MemberDto member, HttpSession session) {
		 ...
		 * 
		 * 1_2) 405 발생 : mapping값 잘씀 type을 GET/POST를 잘못적었을 때
		 * 
